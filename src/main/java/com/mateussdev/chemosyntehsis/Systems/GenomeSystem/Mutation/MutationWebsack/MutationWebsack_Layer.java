...
public class MutationWebsack_Layer<T extends Mob & GeoAnimatable> extends MutationBaseRenderLayer<T> {

    private final GeoModel<MutationWebsack> mutationModel;
    private final GeoRenderer<MutationWebsack> mutationRenderer;

    public MutationWebsack_Layer(GeoRenderer<?> entityRendererIn, MutationWebsack mutation) {
        super((GeoEntityRenderer<?>) entityRendererIn, mutation);
        this.mutationModel = new MutationWebsack_Model();
        this.mutationRenderer = new MutationWebsack_Renderer(mutationModel);
    }
    ...
    public void render(PoseStack poseStack, T animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        ...
        MutationWebsack castedMutationRef = (MutationWebsack) mutationReference;
