...
import net.Mateuss.Chemosynthesis.item.SiliconStageDetector;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> SPAWN_VEG_ROLLER = ITEMS.register("spawn_veg_roller",
            () -> new ForgeSpawnEggItem(ModEntities.VEG_ROLLER, 0x544442, 0x553531,
                    new Item.Properties()));
