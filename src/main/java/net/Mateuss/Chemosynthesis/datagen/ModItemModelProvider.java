...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent(ModItems.SPAWN_BRACHATIC_STAGE.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.SPAWN_SILIPEDE.getId().getPath(), mcLoc("item/template_spawn_egg"));
