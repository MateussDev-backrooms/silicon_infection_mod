...
public class ModelSiliconRoller<T extends Entity> extends HierarchicalModel<T> {
    ...
    public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(ModAnimDefinitions.SILICON_ROLLER_ROLL, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.animate(((EntitySiliconRoller) entity).AS_isIdle, ModAnimDefinitions.SILICON_ROLLER_IDLE, ageInTicks, 1f);
    }
