...
public class ModelSiliconTripod<T extends Entity> extends HierarchicalModel<T> {
    ...
    public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(ModAnimDefinitions.SILICON_TRIPOD_RUN, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.animate(((EntitySiliconTripod) entity).AS_isIdle, ModAnimDefinitions.SILICON_TRIPOD_IDLE, ageInTicks, 1f);
    }
