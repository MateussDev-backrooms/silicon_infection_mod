...
import net.mateuss.chemosynthesis.entity.animations.AnimTetheredPig;
import net.mateuss.chemosynthesis.entity.animations.AnimTetheredSheep;
import net.mateuss.chemosynthesis.entity.custom.EntityTethPig;
